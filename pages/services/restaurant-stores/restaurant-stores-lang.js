...
function bigHeroText() {
  if (getLang() === "ar") {
    bigHero.textContent = "المطاعم والمتاجر";
...
function generalFeatures() {
  if (getLang() === "ar") {
    generalFeaturesh2.innerHTML =
      "مزايا الذكاء الاصطناعي<br>كيف تعزز المراقبة بالذكاء الاصطناعي كفاءة تشغيل المطاعم والمتاجر";
    generalFeaturesP.textContent =
      "تحلّل رقيب بث الكاميرات بشكل لحظي لمتابعة أداء الموظفين، وسرعة الخدمة، ومستوى السلامة التشغيلية داخل المطاعم وبيئات البيع بالتجزئة.";
  } else {
    generalFeaturesh2.innerHTML =
      "AI FEATURES <br> How AI Monitoring Improves Restaurants & Stores Operations";
    generalFeaturesP.textContent =
      "Rgeeb analyzes real-time camera feeds to monitor employee performance, service speed, and operational safety inside restaurants and retail environments.";
  }
